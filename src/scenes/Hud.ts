...
export default class Hud extends Phaser.Scene {
  ...
  create() {
    ...
    this._gamePlay.events.on("set-life", this.setLife, this);
    ...
    //creiamo il gameobject per le vite
    this._livesText = this.add
      .bitmapText(1024, 20, "arcade", "" + this._lives)
      .setFontSize(30) //settiamo il font size a 30
      .setTint(0xffffff) //colore bianco
      .setOrigin(1,0);
  }
  ...
  private setLife(HP:integer): void {
    console.log("No more life Har Har Har")
